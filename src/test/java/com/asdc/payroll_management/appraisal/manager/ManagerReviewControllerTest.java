...
class ManagerReviewControllerTest {
	
	ManagerReviewController underTest = new ManagerReviewController();

	@Test
	void classExistanceTest() {
		try {
			Class<?> classFinder = Class.forName("com.asdc.payroll_management.appraisal.manager.ManagerReviewController");
	...
	@Test
	void createManagerModelTest() {
		try {
			ManagerReviewController managerReviewController = new ManagerReviewController();
			assertEquals("ManagerReview", managerReviewController.createManagerModel().getViewName());
		} catch (Exception e) {
	...
	void getSelfAppraisalTest() {
		try {
			...
			List<Object> actualOutput = underTest.getSelfAppraisal("26119");
	...
	void getAppraisalDataTest() {
		try {
			...
			List<Object> actualResult = underTest.getAppraisalData(managerReviewData);
