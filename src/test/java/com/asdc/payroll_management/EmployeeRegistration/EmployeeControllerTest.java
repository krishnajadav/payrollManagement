...
class EmployeeControllerTest {
	...
	void testEmployeeControllerExist() {
		try {
			Class<?> classObject = Class.forName("com.asdc.payroll_management.EmployeeRegistration.EmployeeController");
	...
	public void TestsaveEmployee() {
		...
		try {
			...
			Employee employee1 = new Employee("1236", "Krishna", "team@gmail.com", "r�AͰa��]�6��L��", null, null, null,
					null, null, null, null);
			Employee employee2 = new Employee("1232", null, null, null, null, null, null, null, null, null, null);
