...
class AppraisalDataDAOTest {
	@Test
	void classExistanceTest() {
		try {
			Class<?> classFinder = Class.forName("com.asdc.payroll_management.appraisal.self.AppraisalDataDAO");
	...
	void getPeerInfoTest() {
		try {
			...
			List<String> actualOutput = appraisalDataDAO.getPeerInfo("26119");
