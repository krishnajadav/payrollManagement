...
public class DBQueriesConstant {
    ...
    public final static String INSERT_REIMBURSEMENT_REQUESTS_QUERY = "Insert into Reimbursement_Request (RR_ID,RR_EmployeeID,RR_TypeID,RR_Note,RR_Amount,RR_Date,isAccepted)";
